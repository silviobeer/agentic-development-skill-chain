...
Suche nach `.claude/skills/references/design-system.md` (erst im Projekt, dann global unter `~/.claude/skills/references/`). Falls vorhanden: Farben, Typografie, Spacing, Komponenten-Muster und Do/Don't-Regeln daraus uebernehmen.
...
Mockups im Browser oeffnen lassen. Feedback via `AskUserQuestion`:
